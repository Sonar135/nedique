...
<?php
    ...
    if(isset($_POST['signup'])){
        ...
        if(doctor_email_exists($conn, $email)!== false){
        ...
        create_doctor($conn, $email, $fname,  $phone, $password );
...
<?php
    ...
    login_doctor($conn, $email, $password);
    }
...
<div class="img_container">
    ...
    <div class="container auth">
           ...
           <form action="" method="post">  <div class="right">
                    ...
                    <div class="n_e">
                        <input type="text" placeholder="full name (surname first)" name="fname">
